...
define("BIND_PORT", 822);

// 房管密码
define("ADMIN_PASS", "17980");
...
define("MUSIC_API", "https://m.sakuya.pw:2020/MKomp");

// Python3 可执行文件位置
define("PYTHON_EXEC", "/usr/bin/python3.7");

// 客户端聊天冷却时间，单位秒
define("MIN_CHATWAIT", 1);

// 聊天内容的最大长度
define("MAX_CHATLENGTH", 2000);

// 音乐的最大长度，单位秒，超过不能点
define("MAX_MUSICLENGTH", 900);

// 每个用户最多可以点多少首歌
define("MAX_USERMUSIC", 10);
